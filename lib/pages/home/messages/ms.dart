                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // );
                          var getDate = post['trans_time'];
                          String getDate1 = '$getDate'.substring(0, 10);
                          var price1 = '${post['trans_money']}';
                          final formatter = new NumberFormat("#,###");
                          var price = int.parse(price1);
                          var money = formatter.format(price);
                          // String money = '${post['trans_time']}';
                          Color color = Colors.red;
                          String textT = 'TRO';
                          String titile = 'Fund transfer sent';
                          String menus = "-";
                          String ac_no = getData.ac_no.toString();
                          ...
                          // String sent = 'Fund transfer sent';
                          // String received = 'Fund transfer sent';

                          return showList(
                            text3: textT,
                            title: titile,
                            detailText: '${post['trans_detail']}',
                            accountText:
                                'To account : ${post['trans_reciever']}',
                            cardText: 'From account : ${post['trans_sender']}',
                            moneyText: '$menus $money kip',
                            color: color,
                            date: getDate1,
                          );
                        },
          ...
          Container(
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned(bottom: 5, right: 5, child: Text("$date")),
                Align(
